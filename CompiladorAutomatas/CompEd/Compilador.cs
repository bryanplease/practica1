...
namespace Compilador
{
    public partial class Ide : Form
    {
        ...
        {
            DialogResult dialogo = MessageBox.Show("¿ Desea cerrar Compilador ?","Cerrar Compilador", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        ...
        public void abrirarchivo()
        {
            ...
            ofd.ShowDialog();
            ofd.Filter = "Archivos Compilador#(*.Autom)|*.Autom";
        ...
        public void guardaArchivo()
        {
            ...
            saveFile.Filter = "Archivos Compilador|*.Autom";
        ...
        private void txt_direccion_Click(object sender, EventArgs e)
        {

        }

        private void Cb_resultados_Click(object sender, EventArgs e)
        {
